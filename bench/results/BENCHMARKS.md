...
> **TL;DR**
>
> - Compress a **4.14 MB** JPEG in **175.5 ms** on Chrome 149 (`canvas-main` path).
> - **`canvas-main`** is the fastest on this hardware (175.5 ms).
...
**Library version:** `@gkzlabs/image-compression@1.3.1`
**Browser:** Chrome/152.0.7977.75
**Run at:** 2026-09-19T03:41:43.498Z
...
| --- | --- | --- | --- | --- | --- |
| `full` | `webcodecs-worker` | 48.0 ms | 43.2 ms | 448.8 KB | 18.8% |
| `no-webcodecs` | `offscreen-worker` | 47.1 ms | 44.4 ms | 448.8 KB | 18.8% |
| `no-workers` | `canvas-main` | 37.0 ms | 35.0 ms | 448.8 KB | 18.8% |
...
<svg viewBox="0 0 730 104" xmlns="http://www.w3.org/2000/svg" font-family="ui-sans-serif, system-ui, sans-serif" font-size="12" role="img" aria-label="Benchmark: medium-1500x1000.jpg">
  ...
  <rect x="160" y="10" width="362.3" height="18" fill="#7aa2ff" rx="3" opacity="1"/>
  <text x="528.2916666666667" y="23" fill="#5dd39e" font-weight="700">37.0 ms ⚡</text>
  <text x="152" y="52" text-anchor="end" fill="#cbd5ff" font-weight="500">offscreen-worker</text>
  <rect x="160" y="42" width="461.2" height="18" fill="#9c7cff" rx="3" opacity="0.85"/>
  <text x="627.1874999999857" y="55" fill="#cbd5ff" font-weight="500">47.1 ms</text>
...
| Config | Actual path | Time (median) | Time (best) | Output | Saved |
| --- | --- | --- | --- | --- | --- |
| `full` | `webcodecs-worker` | 184.6 ms | 181.3 ms | 414.2 KB | 90.2% |
| `no-webcodecs` | `offscreen-worker` | 196.3 ms | 186.1 ms | 414.2 KB | 90.2% |
| `no-workers` | `canvas-main` | 175.5 ms | 167.1 ms | 414.2 KB | 90.2% |
...
<svg viewBox="0 0 730 104" xmlns="http://www.w3.org/2000/svg" font-family="ui-sans-serif, system-ui, sans-serif" font-size="12" role="img" aria-label="Benchmark: large-4000x3000.jpg">
  ...
  <line x1="395.0" y1="4" x2="395.0" y2="100" stroke="#30363d" stroke-width="0.5" stroke-dasharray="2,2"/>
  <text x="395.0" y="103" text-anchor="middle" fill="#6e83b8" font-size="10">98 ms</text>
  <line x1="512.5" y1="4" x2="512.5" y2="100" stroke="#30363d" stroke-width="0.5" stroke-dasharray="2,2"/>
  <text x="512.5" y="103" text-anchor="middle" fill="#6e83b8" font-size="10">147 ms</text>
  <line x1="630.0" y1="4" x2="630.0" y2="100" stroke="#30363d" stroke-width="0.5" stroke-dasharray="2,2"/>
  <text x="630.0" y="103" text-anchor="middle" fill="#6e83b8" font-size="10">196 ms</text>
  <text x="152" y="20" text-anchor="end" fill="#f1f5ff" font-weight="700">canvas-main</text>
  <rect x="160" y="10" width="420.2" height="18" fill="#7aa2ff" rx="3" opacity="1"/>
  <text x="586.1986754966824" y="23" fill="#5dd39e" font-weight="700">175.5 ms ⚡</text>
  <text x="152" y="52" text-anchor="end" fill="#cbd5ff" font-weight="500">webcodecs-worker</text>
  <rect x="160" y="42" width="442.0" height="18" fill="#61DAFB" rx="3" opacity="0.85"/>
  <text x="607.9867549668774" y="55" fill="#cbd5ff" font-weight="500">184.6 ms</text>
  ...
  <text x="636" y="87" fill="#cbd5ff" font-weight="500">196.3 ms</text>
</svg>
...
| --- | --- | --- | --- |
| medium-1500x1000.jpg | `webcodecs-worker` | 48.0 ms | **0.77×** |
| large-4000x3000.jpg | `webcodecs-worker` | 184.6 ms | **0.95×** |
| medium-1500x1000.jpg | `offscreen-worker` | 47.1 ms | **0.79×** |
| large-4000x3000.jpg | `offscreen-worker` | 196.3 ms | **0.89×** |
| medium-1500x1000.jpg | `canvas-main` | 37.0 ms | **1.00×** |
| large-4000x3000.jpg | `canvas-main` | 175.5 ms | **1.00×** |
...
| --- | --- | --- | --- | --- | --- |
| Baseline (q0.85, ≤2048px, cascade) | `webcodecs-worker` | 43.0 ms | 448.8 KB | — | — |
| canvas-main baseline (no sharpen) | `canvas-main` | 34.4 ms | 448.8 KB | 0.80× (-8.6 ms) | 0.0% |
| canvas-main + sharpen 0.3 | `canvas-main` | 54.0 ms | 438.8 KB | 1.26× (+11.0 ms) | 2.2% |
| WebP (q0.85) | `webcodecs-worker` | 230.0 ms | 394.4 KB | 5.35× (+187.0 ms) | 12.1% |
| WebP + qualityBoost | `webcodecs-worker` | 261.7 ms | 656.8 KB | 6.09× (+218.7 ms) | -46.4% |
| maxSizeMB: 0.4 (target-size mode) | `webcodecs-worker` | 176.1 ms | 406.3 KB | 4.10× (+133.1 ms) | 9.5% |
...
| Scenario | Path | Median | Output | vs baseline (time) | vs baseline (size) |
| --- | --- | --- | --- | --- | --- |
| Baseline (q0.85, ≤2048px, cascade) | `webcodecs-worker` | 182.5 ms | 414.2 KB | — | — |
| canvas-main baseline (no sharpen) | `canvas-main` | 170.7 ms | 414.2 KB | 0.94× (-11.8 ms) | 0.0% |
| canvas-main + sharpen 0.3 | `canvas-main` | 254.7 ms | 414.2 KB | 1.40× (+72.2 ms) | 0.0% |
| WebP (q0.85) | `webcodecs-worker` | 510.7 ms | 396.7 KB | 2.80× (+328.2 ms) | 4.2% |
| WebP + qualityBoost | `webcodecs-worker` | 592.4 ms | 885.4 KB | 3.25× (+409.9 ms) | -113.8% |
| maxSizeMB: 0.4 (target-size mode) | `webcodecs-worker` | 369.4 ms | 393.6 KB | 2.02× (+186.9 ms) | 5.0% |
...
| Run | Path | Time | Ratio |
| --- | --- | --- | --- |
| 1 | `webcodecs-worker` | 48.0 ms | 18.8% |
| 2 | `webcodecs-worker` | 43.2 ms | 18.8% |
| 3 | `webcodecs-worker` | 43.2 ms | 18.8% |
| 4 | `webcodecs-worker` | 43.7 ms | 18.8% |
| 5 | `webcodecs-worker` | 44.5 ms | 18.8% |
| 6 | `webcodecs-worker` | 45.2 ms | 18.8% |
| 7 | `webcodecs-worker` | 48.0 ms | 18.8% |
| 8 | `webcodecs-worker` | 49.3 ms | 18.8% |
| 9 | `webcodecs-worker` | 49.0 ms | 18.8% |
| 10 | `webcodecs-worker` | 48.9 ms | 18.8% |

#### large-4000x3000.jpg

| Run | Path | Time | Ratio |
| --- | --- | --- | --- |
| 1 | `webcodecs-worker` | 191.9 ms | 90.2% |
| 2 | `webcodecs-worker` | 183.2 ms | 90.2% |
| 3 | `webcodecs-worker` | 181.3 ms | 90.2% |
| 4 | `webcodecs-worker` | 188.2 ms | 90.2% |
| 5 | `webcodecs-worker` | 184.6 ms | 90.2% |
| 6 | `webcodecs-worker` | 183.8 ms | 90.2% |
| 7 | `webcodecs-worker` | 182.5 ms | 90.2% |
| 8 | `webcodecs-worker` | 185.6 ms | 90.2% |
| 9 | `webcodecs-worker` | 183.2 ms | 90.2% |
| 10 | `webcodecs-worker` | 195.2 ms | 90.2% |
...
| Run | Path | Time | Ratio |
| --- | --- | --- | --- |
| 1 | `offscreen-worker` | 46.4 ms | 18.8% |
| 2 | `offscreen-worker` | 47.3 ms | 18.8% |
| 3 | `offscreen-worker` | 44.7 ms | 18.8% |
| 4 | `offscreen-worker` | 47.9 ms | 18.8% |
| 5 | `offscreen-worker` | 44.8 ms | 18.8% |
| 6 | `offscreen-worker` | 44.4 ms | 18.8% |
| 7 | `offscreen-worker` | 47.1 ms | 18.8% |
| 8 | `offscreen-worker` | 50.2 ms | 18.8% |
| 9 | `offscreen-worker` | 45.3 ms | 18.8% |
...
| Run | Path | Time | Ratio |
| --- | --- | --- | --- |
| 1 | `offscreen-worker` | 219.9 ms | 90.2% |
| 2 | `offscreen-worker` | 189.5 ms | 90.2% |
| 3 | `offscreen-worker` | 186.4 ms | 90.2% |
| 4 | `offscreen-worker` | 206.4 ms | 90.2% |
| 5 | `offscreen-worker` | 193.8 ms | 90.2% |
| 6 | `offscreen-worker` | 198.6 ms | 90.2% |
| 7 | `offscreen-worker` | 199.0 ms | 90.2% |
| 8 | `offscreen-worker` | 186.1 ms | 90.2% |
| 9 | `offscreen-worker` | 196.3 ms | 90.2% |
| 10 | `offscreen-worker` | 190.1 ms | 90.2% |
...
| Run | Path | Time | Ratio |
| --- | --- | --- | --- |
| 1 | `canvas-main` | 41.7 ms | 18.8% |
| 2 | `canvas-main` | 39.2 ms | 18.8% |
| 3 | `canvas-main` | 35.0 ms | 18.8% |
| 4 | `canvas-main` | 38.8 ms | 18.8% |
| 5 | `canvas-main` | 35.0 ms | 18.8% |
| 6 | `canvas-main` | 35.2 ms | 18.8% |
| 7 | `canvas-main` | 37.0 ms | 18.8% |
| 8 | `canvas-main` | 35.3 ms | 18.8% |
| 9 | `canvas-main` | 42.7 ms | 18.8% |
...
| Run | Path | Time | Ratio |
| --- | --- | --- | --- |
| 1 | `canvas-main` | 167.1 ms | 90.2% |
| 2 | `canvas-main` | 179.5 ms | 90.2% |
| 3 | `canvas-main` | 168.9 ms | 90.2% |
| 4 | `canvas-main` | 177.2 ms | 90.2% |
| 5 | `canvas-main` | 169.1 ms | 90.2% |
| 6 | `canvas-main` | 175.5 ms | 90.2% |
| 7 | `canvas-main` | 173.0 ms | 90.2% |
| 8 | `canvas-main` | 168.0 ms | 90.2% |
| 9 | `canvas-main` | 178.9 ms | 90.2% |
| 10 | `canvas-main` | 179.3 ms | 90.2% |
