...
> **TL;DR**
>
> - Compress a **4.14 MB** JPEG in **131.1 ms** on Chrome 149 (`canvas-main` path).
> - **`canvas-main`** is the fastest on this hardware (131.1 ms).
...
**Run at:** 2026-09-13T13:30:41.302Z
...
| --- | --- | --- | --- | --- | --- |
| `full` | `webcodecs-worker` | 38.1 ms | 36.9 ms | 448.8 KB | 18.8% |
| `no-webcodecs` | `offscreen-worker` | 37.7 ms | 36.3 ms | 448.8 KB | 18.8% |
| `no-workers` | `canvas-main` | 29.7 ms | 29.2 ms | 448.8 KB | 18.8% |
...
<svg viewBox="0 0 730 104" xmlns="http://www.w3.org/2000/svg" font-family="ui-sans-serif, system-ui, sans-serif" font-size="12" role="img" aria-label="Benchmark: medium-1500x1000.jpg">
  ...
  <text x="630.0" y="103" text-anchor="middle" fill="#6e83b8" font-size="10">38 ms</text>
  <text x="152" y="20" text-anchor="end" fill="#f1f5ff" font-weight="700">canvas-main</text>
  <rect x="160" y="10" width="366.4" height="18" fill="#7aa2ff" rx="3" opacity="1"/>
  <text x="532.3779527558136" y="23" fill="#5dd39e" font-weight="700">29.7 ms ⚡</text>
  <text x="152" y="52" text-anchor="end" fill="#cbd5ff" font-weight="500">offscreen-worker</text>
  <rect x="160" y="42" width="465.1" height="18" fill="#9c7cff" rx="3" opacity="0.85"/>
  <text x="631.0656167977934" y="55" fill="#cbd5ff" font-weight="500">37.7 ms</text>
  ...
  <text x="636" y="87" fill="#cbd5ff" font-weight="500">38.1 ms</text>
</svg>
...
| Config | Actual path | Time (median) | Time (best) | Output | Saved |
| --- | --- | --- | --- | --- | --- |
| `full` | `webcodecs-worker` | 139.6 ms | 137.5 ms | 414.2 KB | 90.2% |
| `no-webcodecs` | `offscreen-worker` | 140.9 ms | 138.3 ms | 414.2 KB | 90.2% |
| `no-workers` | `canvas-main` | 131.1 ms | 130.4 ms | 414.2 KB | 90.2% |
...
<svg viewBox="0 0 730 104" xmlns="http://www.w3.org/2000/svg" font-family="ui-sans-serif, system-ui, sans-serif" font-size="12" role="img" aria-label="Benchmark: large-4000x3000.jpg">
  ...
  <line x1="512.5" y1="4" x2="512.5" y2="100" stroke="#30363d" stroke-width="0.5" stroke-dasharray="2,2"/>
  <text x="512.5" y="103" text-anchor="middle" fill="#6e83b8" font-size="10">106 ms</text>
  <line x1="630.0" y1="4" x2="630.0" y2="100" stroke="#30363d" stroke-width="0.5" stroke-dasharray="2,2"/>
  <text x="630.0" y="103" text-anchor="middle" fill="#6e83b8" font-size="10">141 ms</text>
  <text x="152" y="20" text-anchor="end" fill="#f1f5ff" font-weight="700">canvas-main</text>
  <rect x="160" y="10" width="437.3" height="18" fill="#7aa2ff" rx="3" opacity="1"/>
  <text x="603.3101490419111" y="23" fill="#5dd39e" font-weight="700">131.1 ms ⚡</text>
  <text x="152" y="52" text-anchor="end" fill="#cbd5ff" font-weight="500">webcodecs-worker</text>
  <rect x="160" y="42" width="465.7" height="18" fill="#61DAFB" rx="3" opacity="0.85"/>
  <text x="631.6635911994708" y="55" fill="#cbd5ff" font-weight="500">139.6 ms</text>
  ...
  <text x="636" y="87" fill="#cbd5ff" font-weight="500">140.9 ms</text>
</svg>
...
| --- | --- | --- | --- |
| medium-1500x1000.jpg | `webcodecs-worker` | 38.1 ms | **0.78×** |
| large-4000x3000.jpg | `webcodecs-worker` | 139.6 ms | **0.94×** |
| medium-1500x1000.jpg | `offscreen-worker` | 37.7 ms | **0.79×** |
| large-4000x3000.jpg | `offscreen-worker` | 140.9 ms | **0.93×** |
| medium-1500x1000.jpg | `canvas-main` | 29.7 ms | **1.00×** |
| large-4000x3000.jpg | `canvas-main` | 131.1 ms | **1.00×** |
...
| --- | --- | --- | --- | --- | --- |
| Baseline (q0.85, ≤2048px, cascade) | `webcodecs-worker` | 37.2 ms | 448.8 KB | — | — |
| canvas-main baseline (no sharpen) | `canvas-main` | 29.9 ms | 448.8 KB | 0.80× (-7.3 ms) | 0.0% |
| canvas-main + sharpen 0.3 | `canvas-main` | 47.7 ms | 438.8 KB | 1.28× (+10.5 ms) | 2.2% |
| WebP (q0.85) | `webcodecs-worker` | 201.1 ms | 394.4 KB | 5.41× (+163.9 ms) | 12.1% |
| WebP + qualityBoost | `webcodecs-worker` | 226.3 ms | 656.8 KB | 6.08× (+189.1 ms) | -46.4% |
| maxSizeMB: 0.4 (target-size mode) | `webcodecs-worker` | 153.0 ms | 406.3 KB | 4.11× (+115.8 ms) | 9.5% |
...
| Scenario | Path | Median | Output | vs baseline (time) | vs baseline (size) |
| --- | --- | --- | --- | --- | --- |
| Baseline (q0.85, ≤2048px, cascade) | `webcodecs-worker` | 139.1 ms | 414.2 KB | — | — |
| canvas-main baseline (no sharpen) | `canvas-main` | 124.5 ms | 414.2 KB | 0.90× (-14.6 ms) | 0.0% |
| canvas-main + sharpen 0.3 | `canvas-main` | 181.1 ms | 414.2 KB | 1.30× (+42.0 ms) | 0.0% |
| WebP (q0.85) | `webcodecs-worker` | 416.6 ms | 396.7 KB | 2.99× (+277.5 ms) | 4.2% |
| WebP + qualityBoost | `webcodecs-worker` | 493.4 ms | 885.4 KB | 3.55× (+354.3 ms) | -113.8% |
| maxSizeMB: 0.4 (target-size mode) | `webcodecs-worker` | 298.2 ms | 393.6 KB | 2.14× (+159.1 ms) | 5.0% |
...
| Run | Path | Time | Ratio |
| --- | --- | --- | --- |
| 1 | `webcodecs-worker` | 38.9 ms | 18.8% |
| 2 | `webcodecs-worker` | 38.1 ms | 18.8% |
| 3 | `webcodecs-worker` | 37.4 ms | 18.8% |
| 4 | `webcodecs-worker` | 37.4 ms | 18.8% |
| 5 | `webcodecs-worker` | 37.7 ms | 18.8% |
| 6 | `webcodecs-worker` | 38.4 ms | 18.8% |
| 7 | `webcodecs-worker` | 36.9 ms | 18.8% |
| 8 | `webcodecs-worker` | 38.7 ms | 18.8% |
| 9 | `webcodecs-worker` | 38.4 ms | 18.8% |
| 10 | `webcodecs-worker` | 37.6 ms | 18.8% |

#### large-4000x3000.jpg

| Run | Path | Time | Ratio |
| --- | --- | --- | --- |
| 1 | `webcodecs-worker` | 137.5 ms | 90.2% |
| 2 | `webcodecs-worker` | 146.3 ms | 90.2% |
| 3 | `webcodecs-worker` | 144.1 ms | 90.2% |
| 4 | `webcodecs-worker` | 137.5 ms | 90.2% |
| 5 | `webcodecs-worker` | 139.4 ms | 90.2% |
| 6 | `webcodecs-worker` | 139.5 ms | 90.2% |
| 7 | `webcodecs-worker` | 138.3 ms | 90.2% |
| 8 | `webcodecs-worker` | 140.3 ms | 90.2% |
| 9 | `webcodecs-worker` | 139.6 ms | 90.2% |
| 10 | `webcodecs-worker` | 140.0 ms | 90.2% |
...
| Run | Path | Time | Ratio |
| --- | --- | --- | --- |
| 1 | `offscreen-worker` | 37.9 ms | 18.8% |
| 2 | `offscreen-worker` | 36.7 ms | 18.8% |
| 3 | `offscreen-worker` | 36.9 ms | 18.8% |
| 4 | `offscreen-worker` | 36.9 ms | 18.8% |
| 5 | `offscreen-worker` | 37.2 ms | 18.8% |
| 6 | `offscreen-worker` | 36.3 ms | 18.8% |
| 7 | `offscreen-worker` | 37.7 ms | 18.8% |
| 8 | `offscreen-worker` | 38.2 ms | 18.8% |
| 9 | `offscreen-worker` | 43.9 ms | 18.8% |
| 10 | `offscreen-worker` | 38.0 ms | 18.8% |

#### large-4000x3000.jpg

| Run | Path | Time | Ratio |
| --- | --- | --- | --- |
| 1 | `offscreen-worker` | 138.3 ms | 90.2% |
| 2 | `offscreen-worker` | 143.1 ms | 90.2% |
| 3 | `offscreen-worker` | 143.5 ms | 90.2% |
| 4 | `offscreen-worker` | 141.3 ms | 90.2% |
| 5 | `offscreen-worker` | 140.9 ms | 90.2% |
| 6 | `offscreen-worker` | 139.5 ms | 90.2% |
| 7 | `offscreen-worker` | 139.9 ms | 90.2% |
| 8 | `offscreen-worker` | 141.6 ms | 90.2% |
| 9 | `offscreen-worker` | 139.4 ms | 90.2% |
| 10 | `offscreen-worker` | 138.6 ms | 90.2% |
...
| Run | Path | Time | Ratio |
| --- | --- | --- | --- |
| 1 | `canvas-main` | 31.2 ms | 18.8% |
| 2 | `canvas-main` | 31.0 ms | 18.8% |
| 3 | `canvas-main` | 29.7 ms | 18.8% |
| 4 | `canvas-main` | 30.3 ms | 18.8% |
| 5 | `canvas-main` | 30.0 ms | 18.8% |
| 6 | `canvas-main` | 29.2 ms | 18.8% |
| 7 | `canvas-main` | 29.3 ms | 18.8% |
| 8 | `canvas-main` | 29.3 ms | 18.8% |
| 9 | `canvas-main` | 29.3 ms | 18.8% |
| 10 | `canvas-main` | 29.5 ms | 18.8% |

#### large-4000x3000.jpg

| Run | Path | Time | Ratio |
| --- | --- | --- | --- |
| 1 | `canvas-main` | 130.7 ms | 90.2% |
| 2 | `canvas-main` | 131.1 ms | 90.2% |
| 3 | `canvas-main` | 133.6 ms | 90.2% |
| 4 | `canvas-main` | 131.1 ms | 90.2% |
| 5 | `canvas-main` | 133.4 ms | 90.2% |
| 6 | `canvas-main` | 130.4 ms | 90.2% |
| 7 | `canvas-main` | 130.9 ms | 90.2% |
| 8 | `canvas-main` | 131.0 ms | 90.2% |
| 9 | `canvas-main` | 130.5 ms | 90.2% |
| 10 | `canvas-main` | 131.8 ms | 90.2% |
